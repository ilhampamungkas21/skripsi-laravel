...
<div class="mui-divider-bottom"></div>
              ...
              Halo Admin <br><br>
              segera cek apakah uang telah di transfer sebanyak {{ $data['harga_total'] }} ke rekening
              Admin(42425252)</p>

              <br>
              <p>No Rekening Pengirim : {{$data['norek_pengirim']}}</p>


              <br>
              <p>ID Pemesanan : {{$data['id_pemesan']}}</p>

              <br>
              <p>Keterangan : ubah status pembayaran apabila telah di transfer ke rekening admin...
                <br>
              {{$data['keterangan']}}</p>
