				...
				<div class="mega-dropdown-menu">
					<div class="w3ls_vegetables">
						<ul class="dropdown-menu drp-mnu">
							...
							@if(Auth::guest())
								 <li><a href="{{url('registerpembeli.html')}}">Register / Login</a></li>
							@endif
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td class="text-center text-danger"><h4><strong> Rp {{$pesanan -> harga_total}}</strong></h4></td>
										...
										<a  href="https://wa.me/{{$pesanan->telepon_penjual}}?text=Halo%20Saya%20{{Auth::user()->name}},%0A
																						Bermaksud%20untuk%20membeli%20{{$pesanan -> nama_barang}}.%0A
																						harga%20per%20kg%20%3A%20{{$pesanan -> barang -> harga_barang}}%0A
																						total%20harga%20%3A%20{{$pesanan -> harga_total}}">
											<button type="button" class="btn btn-success btn-lg btn-block">
